...
//	}
	...
	private static DynamicNode generateTestTreeFor(ArithmeticNode arithmeticNode, ArithmeticTreeTestData treeTestData) {
	...
	private static DynamicTest generateTestFor(ArithmeticNode arithmeticNode, ArithmeticTreeTestData treeTestData) {
		var expected = treeTestData.resultFor(arithmeticNode);
