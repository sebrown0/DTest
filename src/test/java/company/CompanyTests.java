...
class CompanyTests {
	...
	void testPayPeriod_longDate() {
		PayPeriod pp = new CurrentPayPeriod(10, LocalDate.of(2021, Month.OCTOBER, 1), LocalDate.of(2021, Month.OCTOBER, 31));
	...
	void addTwoPayPeriods_toPayGroup() {
		...
		PayPeriod pp11 = new CurrentPayPeriod(11, LocalDate.of(2021, Month.NOVEMBER, 1), LocalDate.of(2021, Month.NOVEMBER, 30));
	...
	void testAdd_twoPayGroups() {
		...
		PayPeriod pp3 = new CurrentPayPeriod(3, LocalDate.of(2021, Month.JANUARY, 7), LocalDate.of(2021, Month.JANUARY, 13));
		...
		assertEquals("02 - 01 Jan 2021  to  06 Jan 2021", result.getPayPeriod(2).getPayPeriodDateWithPeriodNum());
	}

	@Test
	void testAdd_twoPayGroups_getCurrentPayPeriod() {
		PayPeriod pp10 = new CurrentPayPeriod(10, LocalDate.of(2021, Month.OCTOBER, 1), LocalDate.of(2021, Month.OCTOBER, 31));
		PayPeriod pp11 = new CurrentPayPeriod(11, LocalDate.of(2021, Month.NOVEMBER, 1), LocalDate.of(2021, Month.NOVEMBER, 30));
		PayGroup pg1 = new PayGroup("Monthly Paygroup");
		pg1.addPayPeriod(pp10);
		pg1.addPayPeriod(pp11);
		...
		assertEquals("03 - 07 Jan 2021  to  13 Jan 2021", weekly.getCurrentPayPeriod().getPayPeriodDateWithPeriodNum());
	}
}
