 ...
 */
public class ModuleLoaderAtLogin {
	protected Logger logger;
	protected ModuleElements moduleElements;
	...
	/*
	 * Should return HP.
	 * 1. Give it the CoreData objects these can then be passed to the HP. 
	 */
			
	public ModuleLoaderAtLogin(CoreData coreData, ModuleElements moduleElements) {
